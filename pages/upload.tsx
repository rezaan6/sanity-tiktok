...
const Upload = () => {
  ...
  return (
    <div className="flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center">
      <div className="bg-white  rounded-lg xl:h-[80vh] w-[60%] flex gap-6 flex-wrap justify-between  items-center p-14 pt-16">
        <div>
          <div>
          ...
          <div
            className="border-dashed rounded-xl border-4 gray-200 flex flex-col 
          justify-center items-center first-letter outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:border-red-300 hover:bg-gray-100"
          >
            {isLoading ? (
              <p>Uploading....</p>
            ) : (
        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          <div className="flex gap-6 mt-10">
            <button
              onClick={() => {}}
              type="button"
              className=" border-gray-200 border-2 text-base font-medium p-2 rounded w-28 lg:w-44 outline-none"
            >
              Discard
            </button>
